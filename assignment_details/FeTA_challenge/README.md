...
**IMPORTANT**: We need to decide the train/val/test ratio between 80 cases we have to use The label statistics information is for the entire 120 training set data, and we only have 80/120 of these cases.

## Dataset Information

FeTA 2022 (Fetal Tissue Annotation and Segmentation Challenge) is a medical imaging competition dedicated to the reconstruction and segmentation of the fetal brain. The FeTA dataset has hosted two competitions at MICCAI 2021 and MICCAI 2022, and compared to FeTA 2021, which provided single-center data for training and testing, FeTA 2022 focuses more on the generalizability and cross-center applicability of algorithms. FeTA dataset offers 80 cases of T2-weighted fetal brain MRI reconstruction data from two different medical institutions, complete with manual segmentation labels for seven different brain tissues. Through this design, FeTA 2022 aims to promote the application of deep learning algorithms on multi-center, diverse data to improve the accuracy of diagnosis and treatment of fetal brain diseases.
...
Number of two-dimensional slices in the dataset: 30,720 (based on statistics from 120 training cases BUT we only have 80 from the Training set).

## Label Information Statistics - Take into Account this is for the whole training set and we only have 80 of these cases
...
Official Website: [https://feta.grand-challenge.org/](https://feta.grand-challenge.org/)

Download Link: [https://feta.grand-challenge.org/data-download/](https://feta.grand-challenge.org/data-download/)

Article Address: [https://www.nature.com/articles/s41597-021-00946-3](https://www.nature.com/articles/s41597-021-00946-3)
